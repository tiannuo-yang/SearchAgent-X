...
class LLMEngine:
    ...
    def add_request(
        ...
        max_possi_prefix_block_len: Optional[int] = None,
    ) -> None:
        ...
        seq_group.metrics.submit_time = submit_time
        seq_group.metrics.max_possi_prefix_block_len = max_possi_prefix_block_len
    ...
    def step(self) -> List[RequestOutput]:
        ...
        return self._process_model_outputs(output, scheduler_outputs), scheduler_outputs
